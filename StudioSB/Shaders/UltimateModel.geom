...
//in vec4 geomColorSet21[];
//in vec4 geomColorSet22[];
//in vec4 geomColorSet23[];
...
void main()
{
    ...
    for (int i = 0; i < 3; i++)
    {
        ...
        //colorSet21 = geomColorSet21[i];
        //colorSet22 = geomColorSet22[i];
        //colorSet23 = geomColorSet23[i];
        colorSet3 = geomColorSet3[i];
        colorSet4 = geomColorSet4[i];
        colorSet5 = geomColorSet5[i];
        //colorSet6 = geomColorSet6[i];
        //colorSet7 = geomColorSet7[i];
